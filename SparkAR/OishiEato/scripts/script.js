...
function startFoodFeederV2(foodObjList, args) {
    ...
    var positionDataList = [[0.5, 0.0, 0.09883508821974063], [0.4903926402016152, 0.09754516100806412, 0.32549269315678087], [0.46193976625564337, 0.1913417161825449, 0.8567047767916456], [0.4157348061512726, 0.2777851165098011, 0.9791479675167948], [0.3535533905932738, 0.3535533905932738, 0.3482388435659096], [0.27778511650980114, 0.4157348061512726, 0.5889034584442048], [0.19134171618254492, 0.46193976625564337, 0.9931006285166015], [0.09754516100806417, 0.4903926402016152, 0.010220279168632329], [3.061616997868383e-17, 0.5, 0.027492326373756426], [-0.0975451610080641, 0.4903926402016152, 0.40563274796024695], [-0.19134171618254486, 0.46193976625564337, 0.28905202890191717], [-0.277785116509801, 0.4157348061512727, 0.4074333536736422], [-0.35355339059327373, 0.3535533905932738, 0.900559177752991], [-0.4157348061512727, 0.2777851165098011, 0.8441187829072907], [-0.46193976625564337, 0.19134171618254495, 0.9282593328335206], [-0.4903926402016152, 0.0975451610080643, 0.9711714848650497]];
   ...
   for (var i=0; i<foodObjList.length; ++i) {
        ...
        var signal0 = testyPool0.transform.rotationX.gt(Reactive.val(-1.0));
        var signal1 = testyPool0.transform.rotationX.lt(Reactive.val(1.0));
        foodObjList[i].hidden = signal0.and(signal1);
   }
    
}

Diagnostics.watch("rx: ", testyPool0.transform.rotationX);
//Diagnostics.watch("ry: ", testyPool0.transform.rotationY);
//Diagnostics.watch("rz: ", testyPool0.transform.rotationZ);

var signal0 = testyPool0.transform.rotationX.gt(Reactive.val(-1.0));
var signal1 = testyPool0.transform.rotationX.lt(Reactive.val(1.0));
Diagnostics.watch("v: ", signal0.and(signal1));
