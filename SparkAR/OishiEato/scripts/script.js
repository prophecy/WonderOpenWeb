...
const QUOTE_PROD_TRANSFORM = {
    ...
    sandwich: {
        ...
        new_prod_big_scale: [1, 1, 1],//[0.95, 0.95, 0.95],
        new_quote_bg_scale: [1, 1, 1],
        new_quote_text_scale: [1, 1, 1],
...
var GET_THEME_DATA_TIMEOUT = 2000;
